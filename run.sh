...
++datasets.name=LibriTTS_100
++model.tokenizer=char
++model.mel_spec.mel_spec_type=latent
++model.frac_lengths_mask=[0.7,1.0]
++hydra.run.dir=ckpts/F5TTS_Small_vocos_char_LibriTTS_100_360_500_38400_latent
++ckpts.save_dir=ckpts/F5TTS_Small_vocos_char_LibriTTS_100_360_500_38400_latent
++ckpts.exp_name=F5TTS_Small_vocos_char_LibriTTS_100_360_500_38400_latent
++optim.epochs=686
"
