...
++model.arch.refine_type=conv_bilstm
++model.frac_lengths_mask=[0.7,1.0]
++hydra.run.dir=ckpts/F5TTS_Small_vocos_char_LibriTTS_100_360_500_38400_conv_bilstm
++ckpts.save_dir=ckpts/F5TTS_Small_vocos_char_LibriTTS_100_360_500_38400_conv_bilstm
++ckpts.exp_name=F5TTS_Small_vocos_char_LibriTTS_100_360_500_38400_conv_bilstm
++optim.epochs=686
"
