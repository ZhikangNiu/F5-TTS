...
python -m debugpy --wait-for-client --listen 5678 `which accelerate` launch --config_file debug.yaml src/f5_tts/eval/eval_infer_batch.py -s 0 -n "F5TTS_v1_Small_vocos_char_LibriTTS_100_360_500" -t ls_pc_test_clean -nfe 32 -c 700000 --nfe 32
...
for ckpt in 700000 800000 900000 1000000 50000;do
    accelerate launch --config_file "$accelerate_config" --main_process_port 29061 src/f5_tts/eval/eval_infer_batch.py -s 0 -n "F5TTS_v1_Small_vocos_char_LibriTTS_100_360_500" -t "$data" -nfe 32 -c $ckpt
done
# done
