...
# raw text version: keeps original text without pinyin conversion, for edit models using Qwen tokenizer
...
if __name__ == "__main__":
    ...
    langs = ["ZH", "EN"]
    dataset_dir = "/inspire/dataset/emilia/fc71e07/"
    dataset_name = f"Emilia_{'_'.join(langs)}_raw_text"
