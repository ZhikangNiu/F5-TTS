...
# done
for ckpt in 50000 150000;do
    accelerate launch --config_file "$accelerate_config" --main_process_port 29061 src/f5_tts/eval/eval_infer_batch.py -s 0 -n "F5TTS_Small_vocos_char_char_LibriTTS_100_360_500_38400" -t "$data" -nfe 32 -c $ckpt -d LibriTTS_100_360_500 -to char
done
