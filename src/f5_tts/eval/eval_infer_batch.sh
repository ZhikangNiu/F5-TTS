...
for ckpt in 100000 200000 300000;do
    accelerate launch --config_file "$accelerate_config" --main_process_port 29061 src/f5_tts/eval/eval_infer_batch.py -s 0 -n "F5TTS_Small_vocos_char_LibriTTS_100_360_500_38400_conv_mask_padding" -t "$data" -nfe 32 -c $ckpt -d LibriTTS_100_360_500 -to char
done
