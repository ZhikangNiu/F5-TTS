...
cp /inspire/hdd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/niuzhikang-240108120093/dev_f5_be53fb1/checkpoints/utmos22_strong_step7459_v1.pt ~/.cache/torch/hub/checkpoints/
...
gpu_nums=1 # default 4
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:`python3 -c 'import os; import torch; print(os.path.dirname(torch.__file__) +"/lib")'`

exp_name=/inspire/hdd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/niuzhikang-240108120093/f5-prefix/results/F5TTS_v1_Small_vocos_char_LibriTTS_100_360_500_
...
for ckpt in 700000 600000 500000 400000;do
    ...
    # python src/f5_tts/eval/eval_utmos.py --audio_dir $gen_wav_dir  | tee -a "$log_file"
    for task in sim;do    
