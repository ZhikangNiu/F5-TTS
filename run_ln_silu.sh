...
++model.arch.norm_type=ln
++model.arch.silu_ff=True
++model.frac_lengths_mask=[0.7,1.0]
++model.arch.refine_type=conv
++hydra.run.dir=ckpts/F5TTS_Small_vocos_char_LibriTTS_100_360_500_38400_conv_mask_padding_ln_silu_ff
++ckpts.save_dir=ckpts/F5TTS_Small_vocos_char_LibriTTS_100_360_500_38400_conv_mask_padding_ln_silu_ff
++ckpts.exp_name=F5TTS_Small_vocos_char_LibriTTS_100_360_500_38400_conv_mask_padding_ln_silu_ff
++optim.epochs=686
"
